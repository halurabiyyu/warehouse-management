...
@section('content')
    ...
    <div class="fab-container">
        <button class="btn btn-primary btn-fab shadow-lg" data-bs-toggle="modal" data-bs-target="#add-outbound-modal"
            aria-label="Tambah Data">
            <i class="fas fa-plus"></i>
        </button>
    </div>

    @include('admin.outbound.modal')
    @push('styles')
        <style>
            .fab-container {
                position: fixed;
